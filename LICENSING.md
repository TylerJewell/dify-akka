...
A `LICENSE-dify` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [langgenius/dify](https://github.com/langgenius/dify), Copyright
the langgenius/dify authors, licensed under the terms in LICENSE. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../dify-port/specs/SPEC-001-dify.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
